 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --bpp 4 --size 16 --no-compress --font SpaceMono-Regular.ttf --range 32-127 --format lvgl -o space_mono_16.c
 ******************************************************************************/
...
#ifndef SPACE_MONO_16
#define SPACE_MONO_16 1
#endif
...
extern const lv_font_t lv_montserrat_16;
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t space_mono_16 = {
#else
lv_font_t space_mono_16 = {
#endif
